...
export function validateQuickCommandParams (item = {}, values = {}) {
  return (item.params || []).reduce((errors, param) => {
    if (!param.validationType) return errors
    ...
    if (Array.isArray(rawValue)) {
      ...
      for (const value of rawValue) {
        const message = validateValue(param.validationType, value, {
          ...param,
    ...
    const message = validateValue(param.validationType, rawValue, param)
