...
import { deleteBookmarkSelection } from '../common/bookmark-deletion'
...
export default Store => {
  ...
  Store.prototype.delBookmarkSelection = function (ids) {
    return deleteBookmarkSelection(window.store, ids, defaultBookmarkGroupId)
  }
