...
function readRandomBytes (adapters) {
  try {
    ...
    // Fall through to the platform random source.
  }
  try {
...
function createTraceContext (seed = {}, adapters = {}) {
...
function childTraceContext (parent, patch = {}) {
