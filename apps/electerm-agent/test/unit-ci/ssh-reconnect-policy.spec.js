...
test('terminal reconnect UI wires attempt actions, failure state, and success reset', () => {
  ...
  assert.match(overlaySource, /shellpilotReconnectNow/)
  assert.match(overlaySource, /shellpilotStopReconnect/)
  assert.match(overlaySource, /shellpilotReconnectFailed/)
})
