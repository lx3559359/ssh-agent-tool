...
test('connection inventory center is reachable from bookmark UI with localized copy', () => {
  ...
  assert.match(toolbar, /shellpilotServerDetailsConnectionInfo/)
  assert.match(toolbar, /shellpilotEncryptedBackupRecommended/)
  assert.match(toolbar, /shellpilotMigrationGuideTitle/)
  assert.match(treeList, /ConnectionInventoryModal/)
  assert.match(treeList, /onViewConnectionInfo/)
  assert.match(topbar, /label: e\('shellpilotTopbarConnectionInfo'\)/)
  assert.match(topbar, /label: e\('shellpilotTopbarCheckUpdates'\)/)
  assert.match(topbar, /shellpilotTopbarDisconnected/)
  assert.match(inventoryModal, /shellpilotServerDetails/)
  assert.match(inventoryModal, /shellpilotViewConnectionInfo/)
  assert.match(inventoryModal, /shellpilotExportConnectionCsv/)
  assert.match(infoModal, /shellpilotConnectionInfo/)
  assert.match(infoModal, /shellpilotShowPassword/)
  assert.match(infoModal, /shellpilotCopyAll/)
})
