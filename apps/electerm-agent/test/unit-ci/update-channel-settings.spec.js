...
test('common settings page exposes stable and beta update channels', () => {
  ...
  assert.match(source, /e\('themeUpdateChannel'\)/)
  assert.match(source, /e\('shellpilotStableRelease'\)/)
  assert.match(source, /e\('shellpilotBetaRelease'\)/)
  assert.match(source, /value='stable'/)
  assert.match(source, /value='beta'/)
  assert.match(source, /renderUpdateSource/)
  assert.match(source, /e\('shellpilotUpdateSource'\)/)
